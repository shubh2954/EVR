...
API_TOKEN = '6853657954:AAGTaCptQDfuuBs-fsHKUAT2tAaYyZnN-0g'
ADMIN_ID = '5900341019'
MAX_RESTARTS = 5
...
async def main():
    ...
    while True:
        ...
        process = start_bot()
        await notify_admin("🚀 Your Codes Was Successful By SHUBH Bot is starting...")

        while process.poll() is None:
            await asyncio.sleep(5)
        
        logging.warning("Bot process terminated. Restarting in 10 seconds...")
        await notify_admin("⚠️ The bot has crashed Because Of Error Please Check In Your Codespace Terminal If It Is A Syntax Problem Contact Me :- LAST SURVIVOR If It Is Not 🚫 Dont DM Just Chill.")
        restart_count += 1
